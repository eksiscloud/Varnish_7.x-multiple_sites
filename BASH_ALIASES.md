...
alias load-poochie='varnishadm vcl.load poochie-orig-$(date +%s) /etc/varnish/sites/poochierevival.vcl && varnishadm vcl.list'
...
alias label-poochie='varnishadm vcl.label poochie '
...
alias ban-poochie=varnishadm "ban req.http.host == www.poochierevival.info" && varnishadm ban.list'
